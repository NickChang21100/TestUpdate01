...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_TIMER1, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_SOURCE_USB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_HEADSET_CHANNEL_RUNTIME, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STREAM_BIDIRECTIONAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_SYSTEM_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_SYSTEM_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SW_CODEC_SELECT_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SW_CODEC_SELECT_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STREAMCTRL_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STREAMCTRL_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_DATAPATH_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_DATAPATH_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_SYNC_TIMER_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENCODER_STACK_SIZE, 7500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_DATAPATH_STACK_SIZE, 4096);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_BUF_COUNT, 12);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 259);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NVS_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_UNICAST_SERVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MAX_CONN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_MAX_CHAN, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ASCS_ASE_SNK_COUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ASCS_ASE_SRC_COUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_VCS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MCC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PACS_SNK_CONTEXT, 0x0007);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PACS_SRC_CONTEXT, 0x0007);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CSIS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CAP_ACCEPTOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CAP_ACCEPTOR_SET_MEMBER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_ACL_CONN_INTERVAL, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_ACL_SLAVE_LATENCY, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_ACL_SUP_TIMEOUT, 400);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_CONN_TX_POWER_0DBM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_CONN_TX_POWER_DBM, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_ADV_TX_POWER_0DBM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_ADV_TX_POWER_DBM, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_ISO_RX_STATS_S, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_UNICAST_RECOMMENDED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_SERVICES_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_SERVICES_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CS47L63_THREAD_PRIO, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CS47L63_STACK_SIZE, 700);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CS47L63_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CS47L63_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INA231_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INA231_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CTRL_EVENTS_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CTRL_EVENTS_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POWER_MODULE_MIN_MEAS_TIME_MS, 200);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2S_LRCK_FREQ_HZ, 48000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2S_CH_NUM, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_AUDIO_USB_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_AUDIO_USB_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_BUTTON_HANDLER_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_BUTTON_HANDLER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_DFU_ENTRY_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_DFU_ENTRY_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_HW_CODEC_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_HW_CODEC_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_LED_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_LED_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_POWER_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_POWER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_SD_CARD_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_SD_CARD_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POWER_MODULE_THREAD_PRIO, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POWER_MODULE_STACK_SIZE, 1152);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_VERSION_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_VERSION_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHAN_ASSIGNMENT_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHAN_ASSIGNMENT_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CONTIN_ARRAY_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CONTIN_ARRAY_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DATA_FIFO_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DATA_FIFO_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ERROR_HANDLER_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ERROR_HANDLER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FW_INFO_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FW_INFO_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PCM_MIX_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PCM_MIX_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSCM_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSCM_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_DFU, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_USB_AUDIO_HS_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_UNICAST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CODEC_MAX_DATA_COUNT, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CODEC_MAX_DATA_LEN, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CODEC_MAX_METADATA_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CODEC_MAX_METADATA_LEN, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_STREAM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PAC_SNK_LOC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PAC_SRC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PAC_SRC_LOC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PACS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ASCS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ASCS_ASE_SNK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ASCS_ASE_SRC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_VCS_VOCS_INSTANCE_COUNT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_VCS_AICS_INSTANCE_COUNT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CSIS_ENC_SIRK_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CSIS_MAX_INSTANCE_COUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MCC_MEDIA_PLAYER_NAME_MAX, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MCC_ICON_URL_MAX, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MCC_TRACK_TITLE_MAX, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MCC_SEGMENT_NAME_MAX, 25);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_TX_MAX, 12);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF5340_AUDIO_DK_NRF5340_CPUAPP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYNC_RTC_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SDHC_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_TX_FRAG_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_TX_MTU, 251);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_STACK_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SD_LOG_LEVEL_OFF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SD_LOG_LEVEL, 0);
